...
{
    public interface IBaseRepository<in TIdentifier, TEntity, out TRepository> where TEntity : class where TRepository : class, IBaseRepository<TIdentifier, TEntity, TRepository>
    {
        /// <summary>
